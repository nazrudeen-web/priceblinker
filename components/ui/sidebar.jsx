...
// Sidebar Provider component to manage sidebar open/collapsed state
export const SidebarProvider = React.forwardRef(
  ({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
    ...
    // Function to set the sidebar open state and update cookie
    ...
    // Helper to toggle sidebar based on device
...
export const Sidebar = React.forwardRef(
  ({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
    ...
    // If on mobile, use a Sheet component for the sidebar
    if (isMobile) {
      return (
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* This div creates the space for the sidebar when expanded */}
        <div
          className={cn(
        ...
        />
        {/* This is the actual sidebar content container */}
        <div
          className={cn(
...
// Sidebar rail for resizing/toggling
...
// Main content area when using 'inset' sidebar variant
...
// Input component for sidebar (e.g., search)
...
// Grouping for sidebar menu items
...
// Main menu list for sidebar navigation
...
// Variants for sidebar menu buttons
...
// Button for a sidebar menu item
export const SidebarMenuButton = React.forwardRef(
  ({ asChild = false, isActive = false, variant = "default", size = "default", tooltip, className, ...props }, ref) => {
    ...
    // If tooltip is a string, convert it to an object for TooltipContent props
...
// Action button within a sidebar menu item
...
// Badge for a sidebar menu item (e.g., notification count)
...
export const SidebarMenuSkeleton = React.forwardRef(({ className, showIcon = false, ...props }, ref) => {
  // Random width for skeleton text to simulate varying content
...
// Submenu list for sidebar navigation
...
// Individual item in a sidebar submenu
